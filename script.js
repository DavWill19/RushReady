...
function uncheck() {
  ...
  incomplete.classList.add("submit");
...
function submit1() {
  uncheck();
  addNotesOutside("Outside Notes: ", myDIV.textContent);
  addNotesDr("Dining Room Notes: ", myDIV2.textContent);
  addNotesPUW("PUW Notes: ", myDIV3.textContent);
